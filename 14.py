...
# for x in range(14):
#     xxx = (2*14**4 + 10*14**3 +  9*14**2 + x*14**1 + 4*14**0) + (x*18**3 + 4*18**2 + 9*18**1 + 12*18**0)
#     for y in range(21):
#         yyy = xxx - (7*21**3 + y*21**2 + 6*21**1 + y*21**0)
#         if yyy % 219 == 0:
#             print(yyy// 219, (4*x + 3*y)//4)

# 9544
# for x in range(13):
#     z = (5*13**6 + 3*13**5 + 7*13**4 + x*13**3 + 6*13**2 + 2*13**1 + 3*13**0) \
#         - (6*13**5 + x*13**4 + 3*13**3 + 5*13**2 + x*13**1 + 2*13**0)
#     if z % 3 == 0:
#         print(z, x)
